...
impl<TS: TypeSystem> Debug for Instruction<TS> {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            Self::ReturnConstant(arg0, stack_size) => f.debug_tuple("ReturnConstant").field(arg0).field(stack_size).finish(),
            ...
            Self::SetRightOperandRaw(arg0) => f.debug_tuple("SetRightOperandRaw").field(arg0).finish(),
